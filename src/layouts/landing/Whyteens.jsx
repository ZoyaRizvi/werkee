...
export default function Whyteens() {
  return (
    ...
    <h1 className="font-bold text-darken my-3 text-2xl">Why work <span className="text-yellow-500">in your Teens</span></h1>
...
<div  className="grid md:grid-cols-4 gap-14 md:gap-5 mt-20 container mx-auto flex justify-center items-center mt-24">
    <div data-aos="fade-up" className="bg-white shadow-xl p-6 text-center rounded-xl" >
        <div style={{backgroundColor:'teal'}} className="rounded-full w-16 h-16 flex items-center justify-center mx-auto shadow-lg transform -translate-y-12">
            <img className="w-6 h-6 text-white" src="./img/hand.png" alt="Hand" />
        </div>
        <h1  className="font-medium text-xl mb-3 lg:px-14 text-darken">First Income</h1>
    ...
    <h1 className="font-medium text-xl mb-3 lg:px-14 text-darken">Passion</h1>
    <p className="px-4 text-gray-500">
...
<div data-aos="fade-up" data-aos-delay="300" className="bg-white shadow-xl p-6 text-center rounded-xl">
    ...
    <h1 className="font-medium text-xl mb-3 lg:px-14 text-darken lg:h-14 ">Learning</h1>
    <p className="px-4 text-gray-500">
...
<div data-aos="fade-up" data-aos-delay="150" className="bg-white shadow-xl p-6 text-center rounded-xl" >
    ...
    {/* Add similar divs for other items */}
		...
		<div className="grid md:grid-cols-4 gap-14 md:gap-5 mt-20">
			<div data-aos="fade-up" className="bg-white shadow-xl p-6 text-center rounded-xl">
				<div style={"background: teal"} className="rounded-full w-16 h-16 flex items-center justify-center mx-auto shadow-lg transform -translate-y-12">
					<img  className="w-6 h-6 text-white"src="./img/hand.png"/>
			...
			<div data-aos="fade-up" data-aos-delay="150" className="bg-white shadow-xl p-6 text-center rounded-xl">
				<div style={"background: #5b5b5b;"} className="rounded-full w-16 h-16 flex items-center justify-center mx-auto shadow-lg transform -translate-y-12">
					<svg className="w-8 h-8 text-white" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			<div data-aos="fade-up" data-aos-delay="300" className="bg-white shadow-xl p-6 text-center rounded-xl">
				...
				<h1 className="font-medium text-xl mb-3 lg:px-14 text-darken lg:h-14 ">Learning</h1>
				<p className="px-4 text-gray-500">
					Experiential Learning by working on real projects </p>
			</div>
