    ...
    <div className="antialiased">
      <div className="bg-[#FFF2E1]">
        <div className="max-w-screen-xl px-8 mx-auto flex flex-col lg:flex-row items-start">
          ...
          <div className="w-full lg:w-6/12 relative mt-8 lg:mt-0" id="girl">
            <img data-aos="fade-up" data-aos-once="true" className="w-full h-auto mx-auto" src="/img/girl.png" alt="Girl"/>
            
            <div data-aos="fade-up" data-aos-delay="300" data-aos-once="true" className="absolute top-16 -left-6 sm:top-24 sm:left-12 md:top-32 md:left-12 lg:left-4 lg:top-48 floating-4">
               <img height={'400px'} className="bg-opacity-80 rounded-lg h-32 sm:h-24" src='/img/bot.png' alt="Bot"/>
            </div>
          
            <div data-aos="fade-up" data-aos-delay="400" data-aos-once="true" className="absolute top-20 right-10 sm:right-16 sm:top-24 md:top-32 md:right-24 lg:top-32 lg:right-8 floating">
              <img className="h-12 sm:h-16 md:h-20" src='/img/like.png' alt="Like"/>
            </div>

            <div data-aos="fade-up" data-aos-delay="500" data-aos-once="true" className="absolute bottom-14 sm:left-4 sm:bottom-16 lg:bottom-24 lg:left-0 floating">
              <img className="bg-opacity-80 rounded-lg h-20 sm:h-24" src="/img/cat-laptop.png" alt="Cat Laptop"/>
            </div>
            
            <div data-aos="fade-up" data-aos-delay="600" data-aos-once="true" className="absolute bottom-20 md:bottom-32 lg:bottom-40 right-4 lg:right-8 floating-4">
